...
export default function page() {
    return (
        <div className="relative">
            <section className="relative noise w-full overflow-hidden pt-16 md:pt-20 lg:pt-24 pb-0 bg-gradient-to-br from-[#0c0f1c] via-[#0a0d18] to-[#070912] border-b border-white/10">
                ...
                <div className="relative z-10 container mx-auto px-4 md:px-6">
                    <div className="grid lg:grid-cols-2 gap-8 items-start">
                        <div className="space-y-5 pt-4">
                            ...
                            <div className="text-md text-white/80 md:text-lg lg:text-xl mb-10 text-muted-foreground tracking-wide">
