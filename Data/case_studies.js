...
export const caseStudies = [
  {
    ...
    problem: [
      ...
      "These issues lead to misunderstandings, delayed settlements, and unnecessary friction between users",
    ],
    solution:[
      "Splitr follows a simple, intuitive lifecycle:",
              "Add expenses",
              "Automatically split costs (equal, percentage, or custom)",
              "Track balances in real time",
              "Settle up effortlessly",
              "The platform continuously recalculates balances as new expenses are added, giving users a clear and accurate picture of their financial standing across individuals and groups — without manual math or spreadsheets.",
    ],
    experience: [
      ...
      "Designed to feel lightweight, fast, and friction-free",
    ],
    key_features: [
