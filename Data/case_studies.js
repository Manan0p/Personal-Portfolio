...
export const caseStudies = [
  ...
  },
  {
    ...
    problem: {
      intro: "Finding legitimate job opportunities online has become increasingly difficult due to the growing number of scam postings. Common issues include:",
      points: ["Fake recruiters impersonating real companies",
              "Job listings demanding upfront payments or sensitive information",
              "Poorly written or misleading job descriptions",
              "Lack of transparency around company details",
              "Users realizing scams only after financial or data loss"],
      outro: "These problems lead to wasted time, emotional stress, and serious security risks for job seekers.",
    },
    solution: {
      intro: "JobGuard AI introduces an automated verification pipeline that evaluates job postings using a combination of machine learning models and heuristic rules. The system:",
      points: ["Analyzes job descriptions for scam-like language patterns",
              "Verifies company metadata and posting consistency",
              "Assigns a confidence score indicating legitimacy",
              "Flags high-risk listings before users interact with them"],
      outro: "By shifting fraud detection to the discovery phase, JobGuard AI minimizes risk and builds confidence for job seekers.",
    },
    experience: {
      intro: "Users can:",
      points: ["Paste or browse job listings and instantly receive a legitimacy assessment",
              "View clear indicators highlighting suspicious patterns",
              "Understand why a job is flagged through explainable insights",
              "Explore safer alternatives when a posting is deemed risky",
              "Use the platform without technical knowledge or complex workflows"],
      outro: "The experience is designed to be fast, lightweight, and non-intrusive—acting as a safety layer rather than a barrier",
    },
    key_features: [
  {
    icon: <ShieldAlert />,
